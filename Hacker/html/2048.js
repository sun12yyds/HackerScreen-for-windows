...
HTMLActuator.prototype.scoreTweetButton = function () {
  ...
  tweet.setAttribute("href", "javascript:SetWebScore("+ this.score +");");
  tweet.setAttribute("data-via", "weibo");
  tweet.setAttribute("data-url", "");
  tweet.setAttribute("data-counturl", "");
  tweet.textContent = "HackerScreenSaver";
...
function SetWebScore(score){
	if(bastScore>score)return;
